...
elements.configForm.addEventListener('submit', function (e) {
  ...
  elements.uaStatus.innerHTML = 'Đang kết nối...';

  ua = new SIP.UA(config);

  ua.on('connected', function () {
    elements.uaStatus.innerHTML = 'Đã kết nối (nhưng chưa đăng ký)';
  });

  ua.on('registered', function () {
    elements.registerButton.innerHTML = 'Hủy đăng ký';
    elements.uaStatus.innerHTML = 'Đã kết nối (và đã đăng ký)';
  });

  ua.on('unregistered', function () {
    elements.registerButton.innerHTML = 'Đăng ký';
    elements.uaStatus.innerHTML = 'Đã kết nối (nhưng chưa đăng ký)';
  });
...
function createNewSessionUI(uri, session, message) {
  ...
  if (session && !session.accept) {
    ...
    sessionUI.red.innerHTML = 'Hủy';
  } else if (!session) {
    sessionUI.red.disabled = true;
    sessionUI.green.innerHTML = 'Gọi thoại';
    sessionUI.red.innerHTML = '...';
  } else {
    sessionUI.green.innerHTML = 'Chấp nhận';
    sessionUI.red.innerHTML = 'Từ chối';
  }
  ...
  function setUpListeners(session) {
    ...
    session.on('accepted', function () {
      sessionUI.green.disabled = true;
      sessionUI.green.innerHTML = '...';
      sessionUI.red.innerHTML = 'Cúp máy';
